...
| [docs/design-ublk-transport.md](docs/design-ublk-transport.md) | Exploration: ublk as preferred host-local transport alongside NBD; architecture, crash recovery via WAL idempotence, phased rollout |
